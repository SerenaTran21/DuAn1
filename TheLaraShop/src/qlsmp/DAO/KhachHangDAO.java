...
public class KhachHangDAO {
    ...
    String INSERT_SQL = "SET IDENTITY_INSERT KHACHHANG ON; INSERT INTO KHACHHANG(MaKH,TenKH,GioiTinh,NgaySinh,DiaChi,SDT) VALUES(?,?,?,?,?,?)";
    ...
    public void insert(KhachHang enity) {
        DBHelper.update(INSERT_SQL, enity.getMaKH(), enity.getTenKH(), enity.isGioiTinh(), enity.getNgaySinh(), enity.getDiaChi(), enity.getSDT());
    }
