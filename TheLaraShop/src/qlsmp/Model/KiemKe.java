...
public class KiemKe {
    ...
    public KiemKe(int MaKiemKe, String NgayTaoKiemKe, String KyKiemKe, String MucDich, String KetLuan, boolean DaXuLy) {
    ...
    public String getKyKiemKe() {
        return KyKiemKe;
    }

    public void setKyKiemKe(String KyKiemKe) {
        this.KyKiemKe = KyKiemKe;
    }
